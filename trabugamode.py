...
def testesTokensArray():
    assert tokensArray("-13 - -74 + (66 + -57) * -93 * -9 * 77 + 79 - 66 + -53".replace(" ", "")) == ['-13', '-', '-74', '+', '(', '66', '+', '-57', ')', '*', '-93', '*', '-9', '*', '77', '+', '79', '-', '66', '+', '-53']
    assert tokensArray("(-72 - 50 * -74 + -45) * 92 * 21 * 5 * (-13 - 66 - 18)".replace(" ", "")) == ['(', '-72', '-', '50', '*', '-74', '+', '-45', ')', '*', '92', '*', '21', '*', '5', '*', '(', '-13', '-', '66', '-', '18', ')']
    assert tokensArray("-7 - -37 * (90 + 70) - 30 - -44 + -32 - 56 - -48 - -78".replace(" ", "")) == ['-7', '-', '-37', '*', '(', '90', '+', '70', ')', '-', '30', '-', '-44', '+', '-32', '-', '56', '-', '-48', '-', '-78']
    assert tokensArray("65 * -83 - -3 + -20 + 24 - 85 * (-24 + -32) * (61 - 20)".replace(" ", "")) == ['65', '*', '-83', '-', '-3', '+', '-20', '+', '24', '-', '85', '*', '(', '-24', '+', '-32', ')', '*', '(', '61', '-', '20', ')']
    assert tokensArray("55 * 48 * -44 - -32 + 1 * -80 * -94 - 74 * -53 + -30 + -61".replace(" ", "")) == ['55', '*', '48', '*', '-44', '-', '-32', '+', '1', '*', '-80', '*', '-94', '-', '74', '*', '-53', '+', '-30', '+', '-61']
    assert tokensArray("-82 * (25 + 62 + 3) - -72 + -65 * -32 * (77 + 12) - -95 + 51".replace(" ", "")) == ['-82', '*', '(', '25', '+', '62', '+', '3', ')', '-', '-72', '+', '-65', '*', '-32', '*', '(', '77', '+', '12', ')', '-', '-95', '+', '51']
    assert tokensArray("(2 - 65 - (-24 + -97) * -5 * -61) * (-41 + 85 * 9 * -92 * (75 - 18))".replace(" ", "")) == ['(', '2', '-', '65', '-', '(', '-24', '+', '-97', ')', '*', '-5', '*', '-61', ')', '*', '(', '-41', '+', '85', '*', '9', '*', '-92', '*', '(', '75', '-', '18', ')', ')']
    assert tokensArray("-20 + -51 + 20 + -68 * -11 + -35 * -14 - 95 - 32 + -52 * -23 - -90 * -42".replace(" ", "")) == ['-20', '+', '-51', '+', '20', '+', '-68', '*', '-11', '+', '-35', '*', '-14', '-', '95', '-', '32', '+', '-52', '*', '-23', '-', '-90', '*', '-42']
...
"""def testesParseTree():
    assert parseTree(['1', '+', '3']) == 
    assert parseTree(['1', '+', '2', '*', '3'])
    assert parseTree(['4', '/', '2', '+', '7'])
 """

def testesPrecedencia():
    assert precedencia("+") == 1
    assert precedencia("-") == 1
    assert precedencia("+") != 2
    assert precedencia("-") != 2
    assert precedencia("*") == 2
    assert precedencia("/") == 2
    assert precedencia("*") != 1
